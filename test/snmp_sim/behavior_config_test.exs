defmodule SnmpSim.BehaviorConfigTest do
  use ExUnit.Case, async: false

  alias SnmpSim.{BehaviorConfig, ProfileLoader}
  ...
  describe "Behavior Presets" do
    test "cable modem realistic preset contains appropriate behaviors" do
      ...
      # Should have multiple behavior configs
      assert length(behaviors) > 5

      # Should contain traffic counter configuration
      traffic_config =
        Enum.find(behaviors, fn
  ...
  describe "Behavior Application" do
    ...
    test "applies gauge behaviors with range constraints" do
      oid_map = %{
        ...
        "1.3.6.1.2.1.2.2.1.5.1" => %{type: "Gauge32", value: 50},
        # CPU
        "1.3.6.1.2.1.25.3.3.1.2.1" => %{type: "Gauge32", value: 30}
      }
  ...
  describe "Realistic Error Behaviors" do
    test "applies error behaviors to error counter OIDs" do
      oid_map = %{
        ...
        "1.3.6.1.2.1.2.2.1.14.1" => %{type: "Counter32", value: 5},
        # ifOutErrors
        "1.3.6.1.2.1.2.2.1.20.1" => %{type: "Counter32", value: 2},
        # ifInOctets
        "1.3.6.1.2.1.2.2.1.10.1" => %{type: "Counter32", value: 1_000_000}
      }
