defmodule SnmpSimShellIntegrationTest do
  @moduledoc """
  ...
  describe "Shell Command Integration" do
        ...
        {_path, 0} ->
          ...
          case System.cmd(
            ...
            {output, exit_code} ->
              ...
              assert String.contains?(output, "Timeout") or String.contains?(output, "Response") or
                       exit_code != 0
          end
    ...
    # 10 second timeout instead of default 60 seconds
    @tag timeout: 10000
        ...
        {_path, 0} ->
          ...
          case Task.yield(task, 5000) || Task.shutdown(task) do
            ...
            nil ->
              ...
              assert true,
                     "snmpbulkwalk timed out - this indicates network communication was attempted"
          end
