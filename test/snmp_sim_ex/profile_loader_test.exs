defmodule SnmpSim.ProfileLoaderTest do
  ...
  describe "Profile Loading" do
    ...
    test "loads manual definitions correctly" do
      ...
      assert %{type: "STRING", value: "Test Device"} = ProfileLoader.get_oid_value(profile, "1.3.6.1.2.1.1.1.0")
      assert %{type: "INTEGER", value: 4} = ProfileLoader.get_oid_value(profile, "1.3.6.1.2.1.2.1.0")
    end

    test "handles file read errors gracefully" do
      result = ProfileLoader.load_profile(
        :test_device,
